...
სხვა ერთ ვალუტაში გადაყვანის ფუნქცია, ორივე შემთხვევაში თავად მომხმარებელს შეჰყავს სასურველი ვალუტის დასახელება.
შენიშვნა უფასო გასაღებს აქვს გარკვეული ვადა და შესაძლებელია
13th May 2022 (+5 days) აღარ მუშაობდეს.
